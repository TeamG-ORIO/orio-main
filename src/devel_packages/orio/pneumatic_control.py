...
class VacuumControlNode:
    def __init__(self):
        ...
        rospy.Service('snaak/lbl_cup/on', Trigger, self.lbl_on_cb)
        rospy.Service('snaak/lbl_cup/off', Trigger, self.lbl_off_cb)

        # Services for PnP Cup
        rospy.Service('snaak/pnp_cup/on', Trigger, self.pnp_on_cb)
        rospy.Service('snaak/pnp_cup/off', Trigger, self.pnp_off_cb)

        # Global Disable
        rospy.Service('snaak/vacuum/disable_all', Trigger, self.disable_all_cb)
